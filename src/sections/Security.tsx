      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="rounded-[2.5rem] bg-gradient-to-br from-brand-100/60 via-white to-accent-violet/10 p-8 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.25)] sm:p-12">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-brand-600">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {items.map((it) => (
              <article
                key={it.title}
                className="rounded-3xl bg-white p-6 shadow-[0_18px_50px_-22px_rgba(15,23,42,0.18)] transition hover:-translate-y-1 hover:shadow-[0_28px_60px_-22px_rgba(15,23,42,0.25)]"
              >
